 ...
 */
final class Version20260114234654 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE adoption_history (id INT AUTO_INCREMENT NOT NULL, status VARCHAR(20) NOT NULL, decided_at DATETIME NOT NULL, note LONGTEXT DEFAULT NULL, rejection_reason VARCHAR(100) DEFAULT NULL, adoption_request_id INT NOT NULL, decided_by_id INT DEFAULT NULL, INDEX IDX_5D25693AECFD9D75 (adoption_request_id), INDEX IDX_5D25693AE26B496B (decided_by_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE adoption_request (id INT AUTO_INCREMENT NOT NULL, full_name VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, message LONGTEXT DEFAULT NULL, created_at DATETIME NOT NULL, survey_answer LONGTEXT DEFAULT NULL, pet_id INT NOT NULL, applicant_id INT NOT NULL, INDEX IDX_410896EE966F7FB6 (pet_id), INDEX IDX_410896EE97139001 (applicant_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        ...
        $this->addSql('CREATE TABLE pets (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, species VARCHAR(20) NOT NULL, age INT DEFAULT NULL, image VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, breed VARCHAR(100) DEFAULT NULL, sex VARCHAR(20) DEFAULT NULL, color VARCHAR(50) DEFAULT NULL, size VARCHAR(50) DEFAULT NULL, adoption_requirements LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, shelter_id INT DEFAULT NULL, INDEX IDX_8638EA3F54053EC0 (shelter_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(180) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_IDENTIFIER_EMAIL (email), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
